// no import cause there is no types anyway
import type { MeasureResult } from "measuresuite/measure.interface";
import { defaults, zip } from "lodash";
import * as Stats from "simple-statistics";

type numTripel = [cyclesA: number, cyclesB: number, cyclesC: number];
